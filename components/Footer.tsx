...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full max-w-dvw p-4 py-6 lg:py-8">
        <div className="md:flex md:max-w-screen-xl md:mx-auto md:justify-between">
        ...
        <div className=" md:max-w-screen-xl mx-auto w-full">
          <h2 className="text-2xl font-bold text-left mt-6 mb-4">Contact Us</h2>
          <div className="w-full grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-700">Mon – Sat, Sunday: Closed</p>
            </div>
