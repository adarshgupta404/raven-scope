...
const Hero = () => {
  return (
    <section>
      <div className="bg-black h-fit flex justify-center md:min-h-[calc(100dvh-84px)] mx-auto text-white md:py-20">
        <div className="container mx-auto flex flex-col md:flex-row max-w-screen-xl items-center">
          <div className="flex flex-col md:w-1/2 justify-center items-start p-8">
            ...
            <h2 className="text-3xl md:text-5xl leading-relaxed md:leading-snug mb-2">
              Uncover the Truth, Fact can't be Hidden!
            </h2>
